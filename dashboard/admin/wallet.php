<?php 
    ...
    if(isset($_POST['submit'])){
      ...
      $sql = "INSERT INTO wallet ( name, wallet_address ) values('$name','$wallet')";
      ...
      if($query){
          ...
          echo "<script>
                  alert('Wallet Info registered successfully');
                  location.href ='wallet.php';
                </script>"; 
      }else {
          
          echo "Wallet Info not added";
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-4">
                    <div class="card">
                        <div class="row">
                          <div class="col-10">
                              <h3 class="card-header pb-0">Wallet</h3>
                          </div>
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-lg-12 mb-4 order-0">
                                      ...
                                      <form id="formAuthentication" class="mb-3" role="form" action="wallet.php" method="post" enctype="multipart/form-data">
                                          <div class="row pt-2">
                                      <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="py-2 form-control" placeholder="Enter Name of Coin" name="name" />
                                      ...
                                      <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="py-2 form-control" placeholder="Enter Wallet Address" name="wallet" />
                                                    
                                            </div>
                                      </div>
                                      <div class="col-4">
                                          <label for="" class="col-12 mb-2">.</label>
                                          <input class="btn btn-info" type="submit" name="submit" value="Add Wallet">
                                      </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" >
                                                ...
                                                <form role="form" action="wallet.php" method="post" enctype="multipart/form-data">
