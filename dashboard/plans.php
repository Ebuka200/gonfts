      ...
      <div class="layout-container">
       ...
       <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
                <a href="minting.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-food-menu"></i>
                  <div data-i18n="Analytics">Minting</div>
                </a>
              </li>
            <!-- Components -->
            ...
            <!-- <li class="menu-item">
                <a href="referral.php" class="menu-link">
                  ...
                  <div data-i18n="Basic">Referrals</div>
                </a>
            </li> -->
            <li class="menu-item">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mb-5">
                        <h3 class="mt-4">Our Plans</h3>
                            <div class="col-md-6 col-lg-4 mb-3 mt-5">
                              <div class="card h-100">
                                <div class="card-body">
                                  <h5 class="card-title">Basic</h5>
                                  <p class="card-text"> $100 - $49,999</p>
                                  <p class="card-text"><strong>Daily Percentage: 0.25%</strong></p>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3 mt-5">
                                <div class="card h-100">
                                    <div class="card-body">
                                            ...
                                            <p class="card-text"> $50,000 - $499,999</p>
                                            <p class="card-text"><strong>Daily percentage : 0.30%</strong> </p>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3 mt-5">
                                <div class="card h-100">
                                    <div class="card-body">
                                            ...
                                            <p class="card-text"> $500,000 - $1,000,000</p>
                                            <p class="card-text"><strong>Daily Percentage : 0.50%</strong> </p>
                                             ...
                                             <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <h2 class="text-center" id="exampleModalLabel1 ">Basic</h2><hr class="mx-5">
                                                    ...
                                                    <div class="modal-body" >
                                                        ...
                                                        <h6 class="text-center text-info" id="price">0.01</h6>
                                            ...
                                            <div class="modal fade" id="basicModal1" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <h5 class="text-center mt-2" id="exampleModalLabel1">Complete Investment</h5>
                                                    <h2 class="text-center" id="exampleModalLabel1 ">Pro</h2><hr class="mx-5">
                                                    ...
                                                    <div class="modal-body" >
                                                        ...
                                                        <p class="text-center text-info mt-4">You can pay $50,000 - $499,999 </p>
                                                        <h6 class="text-center text-info" id="price">0.01</h6>
                                                        <h6 class="text-center ">to the following wallet Address</h6><br>
                                            ...
                                            <div class="modal fade" id="basicModal2" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <h5 class="text-center mt-2" id="exampleModalLabel1">Complete Investment</h5>
                                                    <h2 class="text-center" id="exampleModalLabel1 ">Premium</h2><hr class="mx-5">
