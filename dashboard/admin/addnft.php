      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account /</span>Add nft's</h4>
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link " href="nft.php"><i class="bx bx-food-menu me-1"></i> NFT's</a>
                    </li> 
                     <li class="nav-item">
                ...
                <div class="row pt-2 mt-4 ">
                    <form id="formAuthentication" role="form" action="addnft.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-4 ">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-4 ">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="category" id="exampleFormControlSelect1" aria-label="Default select example">
                                        <option value="Arts/Paintings">Arts/Paintings</option>
                                        <option value="Collectibles">Collectibles</option>
                                        <option value="Music">Music</option>
                                        <option value="Photography">Photography</option>
                                        <option value="Sport">Sport</option>
                                        <option value="Trading Cards">Trading Cards</option>
                                        <option value="Virtual World">Sport</option>
                                    </select>
                                </div>
                            </div>
