        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Confirmation</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Please provide the following details for confirmation</h5>
                    <?php if ($err_flag = false){ ?>
                    <p class="card-header text-danger ">File is larger than requirement</p>
                    <?php } ?>
                    <!-- Account -->
                    <div class="card-body">
                            ...
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                        <span class="d-none d-sm-block">Upload photo of payment</span>
                                        <i class="bx bx-upload d-block d-sm-none"></i>
                                        <!-- <input
                                        type="file"
                                        id="name"
                                        class="account-file-input p-2"
                                        accept="image/png, image/jpeg"
                                        name="confirm"
                                        /> -->
                                        <input class=" p-3 col-lg-12 form-control form-radius" name="thumbnail" type="file" id="name" placeholder="Last Name">

                                    </label>
                                
                                    <p class="text-info mb-0">Allowed JPG, GIF or PNG. Max size of 800KB</p>

                                </div>
                            
                            </div>
                            <div class="mb-3 mt-3">
                                <input href="" class="p-2 btn btn-primary d-grid w-100" type="submit" name="submit" value="Submit"/>
                            </div>
              ...
              <a href="index.php">
                <p class="text-center">Go back to dashboard</p>
              </a>
            </div>
            <!-- / Content -->
