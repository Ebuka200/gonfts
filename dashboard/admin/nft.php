        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account /</span> nft's</h4>
              <ul class="nav nav-pills flex-column flex-md-row mb-3">
                      <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-food-menu me-1"></i> NFT's</a>
                      </li> 
                      <li class="nav-item">
                        <a class="nav-link" href="addnft.php"
                          ><i class="bx bx-link-alt"></i> Add NFT</a
                        >
                      </li>
                      <!-- <li class="nav-item">
                        <a class="nav-link" href="pages-account-settings-connections.html"
                          ><i class="bx bx-link-alt me-1"></i> Collections</a
                        >
                      </li> -->
              </ul>
                          ...
                          <div class="col-lg-3 col-md-12 col-6 mb-4">
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <h6 class="mt-2"><?php echo $row['category'] ?></h6>
                                      
                                      <a href="nftdetail.php">
                                        <small class="text-success fw-semibold">Show More<i class="bx bx-right-arrow-alt"></i></small>
                                      </a>
                                  </div>
                              </div>
                          </div>  
