<?php
    ...
    // $query2 = "SELECT * FROM productdetails";
    ...
    if(isset($_POST['submit'])){
      ...
      $invoice = $_POST['invoice'];
          ...
          <script>
                  ...
                  location.href = 'tracking.php?invoice=$invoice';
                </script>"; 
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Track Your Product</h1>
                    <p class="mb-5">Enter your tracking number to retrieve your details</p>
                    <!-- <div class="d-flex align-items-center">
                        <i class="fa fa-headphones fa-2x flex-shrink-0 bg-primary p-3 text-white"></i>
                        <div class="ps-4">
                            <h6>Call for any query!</h6>
                            <h3 class="text-primary m-0">+174-7308-3545</h3>
                        </div>
                    </div> -->
                </div>
                <div class="col-lg-7">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-12 col-sm-12">
                                    <input type="text" class="form-control border-0" name="invoice" placeholder="Enter tracking number" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <input class="btn btn-primary w-100 py-3" type="submit" name="submit" value="Submit"/>
                                </div>
                            </div>
                        </form>
                    </div>
