...
if(isset($_POST['submit'])){
  ...
  if(isset($err_flag) && $err_flag === false){
      ...
      $sql = "UPDATE accounts SET firstname='$firstname', lastname='$lastname', email='$email', walletaddress='$address', password='$newpassword' WHERE username='$username' ";
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account Settings /</span> <?php echo $username ?></h4>
                                ...
                                <div class="card-body">
                                          ...
                                          <div class="row">
                                            ...
                                            <!-- <div class="mb-3 col-md-12">
                                              ...
                                              <div class="mb-3 col-md-12">
                                                  <label for="btc" class="form-label">Re-enter Password</label>
                                                  <input
                                                    class="form-control"
                                                    type="password"
                                                    id="btcaddress"
