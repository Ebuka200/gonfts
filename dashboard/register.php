<?php
    ...
    if(isset($_POST['submit'])){
      ...
      // $newammount = $ammount - $referral_total; 
      // echo("<br>");
      // print_r($ammount);
      // echo("<br>");
      // print_r($newammount);
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">please fill in your details carefully</p>

              <form id="formAuthentication" class="mb-3" role="form" action="register.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <label for="wallet" class="form-label">Referral User</label>
                  <input type="text" class="form-control" id="reflink" name="refuser" placeholder="Enter your refferal link" value="<?php
                ...
                <input href="" class="btn btn-primary d-grid w-100" type="submit" name="submit" value="Sign Up"/>
